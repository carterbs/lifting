...
function StretchIcon(): JSX.Element {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      {/* Person in stretching pose - lunging/stretching position */}
...
function CalendarDaysIcon(): JSX.Element {
  return (
    <svg
      width="24"
      height="24"
...
function MeditationIcon(): JSX.Element {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      {/* Simple circle representing breathing/mindfulness */}
